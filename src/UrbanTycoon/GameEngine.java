...
class GameEngine extends JPanel {
    ...
    private final JLabel moneyLabel, dateLabel, zoneInfoLabel, satisfactionLabel, taxLabel, populationLabel;
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        for (int i = 0; i < FIELDROWSNUM; i++) {
            for (int j = 0; j < FIELDCOLSNUM; j++) {
                ...
                populationLabel.setText("Population: " + city.getResidentsNum());
                if (city.getSelectedField() != null) {
                    zoneInfoLabel.setText(city.getFieldInfo());
                }
            }
        }
